                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <form action="{{route('admin.user.photo.update', ['user_id'=>$user->id])}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <strong><i class="fas fa-pencil-alt mr-1"></i> Profession</strong>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        ...
                                        <form action="{{route('admin.user.update', ['user_id'=>$user->id])}}" method="POST" class="form-horizontal">
                                            @csrf
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text " value="{{$user->state}}" class="form-control" name="state" placeholder="Skills separated by a comma">
                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                <label for="inputSkills" class="col-sm-2 col-form-label">Address</label>
                                                <div class="col-sm-10">
                                                    <input type="text " value="{{$user->address}}" class="form-control" name="address" placeholder="Your Address">
                                                </div>
                                            </div>
                                          ...
                                          @if(auth()->check() && auth()->id()==$user->id)
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="password" class="form-control" name="password" placeholder="Warning! Updating this will change your password!">
                                                </div>
                                            </div>
